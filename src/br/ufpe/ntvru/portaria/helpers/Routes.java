package br.ufpe.ntvru.portaria.helpers;

public class Routes {

	
	    public static String LOGINVIEW = "/br/ufpe/ntvru/portaria/login/Login.fxml";
	    public static String MAINVIEW = "/br/ufpe/ntvru/portaria/view/MainFX.fxml";
	    //public static String MAINVIEW = "/br/ufpe/ntvru/portaria/portariafx/HomeView.fxml";

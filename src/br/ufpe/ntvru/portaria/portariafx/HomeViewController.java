...
public class HomeViewController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            VBox sidePane = FXMLLoader.load(getClass().getResource("/br/ufpe/ntvru/portaria/portariafx/Drawer.fxml"));
            AnchorPane visitorsPane = FXMLLoader.load(getClass().getResource(Routes.VISITORSVIEW));
